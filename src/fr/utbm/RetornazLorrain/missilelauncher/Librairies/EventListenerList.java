package fr.utbm.RetornazLorrain.missilelauncher.Librairies;
...
public class EventListenerList implements Serializable {
	...
	public synchronized <T extends java.util.EventListener> void remove(final Class<T> listenerClass,
																		final T listener) {
		if (listener == null) {
			return;
		}
	...
	public synchronized <T extends java.util.EventListener> void add(	final Class<T> listenerClass,
																		final T listener) {
		if (listener == null) {
			return;
		}
